...
public class JavaFXVideoPlayerLaunchedFromSwing {
    private static void initAndShowGUI() {
        ...
        frame.add(fxPanel); // add the fxPanel
...
class SceneGenerator {
    ...
    public Scene createScene() {
        ...
        String image = JavaFXVideoPlayerLaunchedFromSwing.class.getResource("background.jpg").toExternalForm();
        layout.setStyle("-fx-background-image: url('" + image + "'); " +
                "-fx-background-position: center center; " +
                "-fx-background-repeat: stretch;" +
                        " -fx-font-size: 20; -fx-padding: 20; -fx-alignment: center;"
        );
